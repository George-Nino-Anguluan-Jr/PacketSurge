...
const TOWER_DEFINITIONS = {
	"tower_array": {
		...
		"color":       Color("#00D4FF"),
		"icon_text":   "[ ]",
		"ability_name":"O(1) Burst",
		"spire_variant":"tower_01",
		"spire_base_h": 128,
	},
	"tower_stack": {
		...
		"color":       Color("#FF6B35"),
		"icon_text":   "↑↓",
		"ability_name":"Stack Pop",
		"spire_variant":"tower_02",
		"spire_base_h": 192,
	},
	"tower_queue": {
...
const ENEMY_DEFINITIONS = {
	"basic_packet":    { "color": Color("#FF3366") },
	"indexed_packet":  { "color": Color("#00D4FF") },
	"overflow_packet": { "color": Color("#8E44AD") },
	"queue_jumper":    { "color": Color("#FF6B35") },
	"linked_drain":    { "color": Color("#2ECC71") },
	"bubble_shield":   { "color": Color("#95A5A6") },
	"pivot_splitter":  { "color": Color("#E74C3C") },
	"selection_mark":  { "color": Color("#E74C3C") },
	"insertion_stack": { "color": Color("#1ABC9C") },
	"merge_twin":      { "color": Color("#3F51B5") },
	"count_meter":     { "color": Color("#009688") },
	"radix_digit":     { "color": Color("#FF5722") },
	"scan_wave":       { "color": Color("#607D8B") },
	"binary_mask":     { "color": Color("#8BC34A") },
}
